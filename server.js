...
const GD_TOPICS = [
  ...
  "Justice reforms: Pending agenda",
  ...
  "Net neutrality: Success or failure?",
  ...
  "Genetic food modification ethics",
  ...
  "Tier-1 vs Tier-3 colleges: Placement opportunities?",
  ...
  "Neural networks replacing human decisions",
  ...
  "Reality vs expectations in engineering jobs",
  "UPI vs global fintech competition",
  "Education system reform needed?",
  "Organic vs junk food lifestyles",
  "Data localization: Pros and cons",
  "Mentorship vs self-learning",
  "Climate change responsibility — individuals or governments?",
  "Artificial intelligence replacing teachers?",
  "Triple talaq: Women's rights victory?",
  "Elderly care: Society's responsibility",
  "Green energy future: Is 100% renewable possible?",
  "Drug abuse among youth: Growing menace",
  ...
  "Courage to improve and accept failure",
  "UPI — global payment leader?",
  "Quantum supremacy — hype or future?",
